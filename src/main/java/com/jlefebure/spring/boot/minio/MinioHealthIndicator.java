...
public class MinioHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        if (this.minioClient == null) {
            ...
            } catch (IOException | NoSuchAlgorithmException | InsufficientDataException | InvalidKeyException | NoResponseException | XmlPullParserException | ErrorResponseException | InternalException | InvalidResponseException | InvalidBucketNameException var2) {
                return Health.down(var2).withDetail("bucketName", this.minioConfigurationProperties.getBucket()).build();
            }
        }
    }
}
